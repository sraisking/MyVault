...
public class MyVaultDaoImpl implements MyVaultDao {
	...
	public List<Password> getAllPasswords() {
		// TODO Auto-generated method stub
		return sessionFactory.getCurrentSession().createQuery("from Password").list();
	}

	public void deletePassword(int site) {
		Password password = (Password) sessionFactory.getCurrentSession().load(Password.class, site);
		if (null != password) {
